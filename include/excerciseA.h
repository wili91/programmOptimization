 ...
 */
template<std::size_t N, typename T>
T plain_minimum_index(std::array<T,N>& arr, std::size_t start_index,std::size_t end_index)
{
 ...
 */
template<std::size_t N, typename T>
T minimum_two_loops(std::array<T,N>& arr, std::size_t start_index, std::size_t end_index)
{
	T min = arr[start_index];
 ...
 */
template<std::size_t N, typename T>
T minimum_two_loops_index(std::array<T,N>& arr, std::size_t start_index, std::size_t end_index)
{
	std::size_t min_index = start_index;
 ...
 */
template<std::size_t N, typename T>
T minimum_prefetch(std::array<T,N>& arr, std::size_t start_index, std::size_t end_index)
{
	T min = arr[start_index];
